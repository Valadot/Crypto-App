  ...
  const getCoinlist = async (prevCoins = coinList, defaultPage = page) => {
    try {
      ...
      const { data } = await axios(
        `https://api.coingecko.com/api/v3/coins/markets?vs_currency=${formattedCurrency}&order=market_cap_desc&per_page=30&page=${defaultPage}&sparkline=true&price_change_percentage=1h%2C24h%2C7d&locale=en`
      );
